 ...
 *
 * 2.Comparable接口与Comparator的使用与对比：
...
public class CompareTest {
        ...
        1.像String,包装类等实现了Comparable接口，重新了compareTo(obj)方法，给出了比较两个对象大小的方式
        2.像String,包装类重新了compareTo(obj)方法以后，进行了从小到大的排列
        3.重新compareTo(obj)的规则：
    ...
    public void test4(){
        ...
        Arrays.sort(arr, new Comparator<Goods>() {
            //指明商品比较大小的方式：按照产品名称从低到高排序，再按照产品价格从高到低排序
            @Override
