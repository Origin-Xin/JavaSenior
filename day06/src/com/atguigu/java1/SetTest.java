 ...
 *  要求：重写的hashCode()和equals尽可能保持一致性：相等的对象必须具有相等的散列码
...
public class SetTest {
    ...
    2.不可重复性：保证添加的元素按照equals()判读时，不能返回true。即：相同的元素只能添加一个

    二.添加元素的过程：以HashSet为例子：
    我们向HashSet中添加元素啊，首先调用元素a所在类的hashCode()方法，计算元素a的哈希值，
